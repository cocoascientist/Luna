...
public struct LunarPhaseView: UIViewRepresentable {
    public typealias UIViewType = LunarPhaseViewImpl
    
    public init() { }
    
    public func makeUIView(context: UIViewRepresentableContext<LunarPhaseView>) -> LunarPhaseViewImpl {
    ...
    public func updateUIView(_ uiView: LunarPhaseViewImpl,
                      context: UIViewRepresentableContext<LunarPhaseView>) {
        uiView.backgroundColor = UIColor.clear
    }
}

public final class LunarPhaseViewImpl: UIView {
